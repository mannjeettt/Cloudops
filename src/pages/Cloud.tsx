import { Cloud as CloudIcon, Database, HardDrive, Server } from "lucide-react";
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        {cloudProviders.map((provider) => (
          <Card key={provider.name} className="bg-card border-border">
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={`${item.provider}-${item.service}`} className="flex items-center justify-between p-3 bg-background border border-border rounded-lg">
                  <div>
